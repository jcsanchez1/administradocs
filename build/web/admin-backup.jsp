        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/administradocs/BackupRestoreDataBase">
                            <div class="form-group">
                                <label for="backup">Backup:</label> <button 
                                                                           name="backup" id="backup"
                                                                           class="btn btn-primary">Respaldar</button>
                            </div>
                            <div class="form-group">
                                <label for="restore">Restore:</label> <input type="file"
                                                                             name="file" disabled="disabled" class="form-group"> <button 
                                                                             name="restore" id="restore"
                                                                             class="btn btn-danger" disabled="disabled">Restaurar</button>
                            </div>
                        </form>
                    </div>
                </div>
