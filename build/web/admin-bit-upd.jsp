...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Bitacoras</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="admin-bit-new.jsp"><i class="icon fa fa-circle-o"></i> Registros nuevos</a></li>
                <li><a class="treeview-item active" href="admin-bit-upd.jsp"><i class="icon fa fa-circle-o"></i> Registros modificados</a></li>
...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="#">actualizados</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tile-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <%
                                try {
                                    sql = "SELECT tbl_bitacora.idbitacora, tbl_bitacora.tabla, tbl_bitacora.fechacreacion, tbl_bitacora.executedSQL, tbl_bitacora.reverseSQL FROM tbl_bitacora WHERE tbl_bitacora.accion = 'update' ORDER BY tbl_bitacora.tabla";
                                    rs = cn.ejecutarConsultabitacora(sql);
                                    String id, tabla, fecha, execute, reverse;
                            %>
                            <tbody>
                                <%
                                    while (rs.next()) {
                                        ...
                                        execute = rs.getString(4);
                                        reverse = rs.getString(5);
                                %><tr>
                                    <td><%=id%> </td>
                                    <td><%=tabla%></td> 
                                    <td><%=fecha%></td> 
