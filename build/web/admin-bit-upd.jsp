        ...
        <aside class="app-sidebar">
          ...
          <p class="app-sidebar__user-designation">${persona.idFilial.nombrefilial}</p>
            ...
            <ul class="app-menu">
                ...
                <li class="treeview is-expanded"><a class="app-menu__item is-expanded" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Bitacoras</span><i class="treeview-indicator fa fa-angle-right"></i></a>
