...
<html lang="en">
    <head>
        ...
        <title>Sistema de gestion de afiliados - ${persona.nombre} - Servicio al Afiliado</title>
        <meta charset="utf-8">
        ...
        <aside class="app-sidebar">
          ...
          <p class="app-sidebar__user-designation">${persona.idFilial.nombrefilial}</p>
            ...
            <ul class="app-menu">
                ...
                <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Afiliados</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a class="treeview-item" href="sac-afi-list.jsp"><i class="icon fa fa-circle-o"></i> Listar Afilidos Filia</a></li>
                        <li><a class="treeview-item active" href="sac-afi-new.jsp"><i class="icon fa fa-circle-o"></i> Nuevo Afiliado</a></li>
                ...
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Afiliados</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Nuevo Afiliado</h5>
                                <form action="/administradocs/personaControlador" method="POST" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label for="nombre" class="col-4 col-form-label">Primer Nombre</label> 
                                        <div class="col-8">
                                    ...
                                    <div class="form-group row">
                                        <div class="offset-4 col-8">
                                            <button name="btnguardarpersona" type="submit" class="btn btn-primary">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
