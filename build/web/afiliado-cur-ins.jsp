        ...
        <ul class="app-menu">
            ...
            <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Cursos</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    ...
                    <li><a class="treeview-item active" href="afiliado-cur-ins.jsp?idper=${persona.id}"><i class="icon fa fa-circle-o"></i> Inscritos</a></li>
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                ...
                                <tbody> 
                                    ...
                                    <tr>
                                        ...
                                        <td><%=a5%></td>
                                        <td><%=a6%></td>
                                        <td><a href="afiliado-cur-ins-new.jsp?dni=<%=a1%>" class="btn btn-primary">marcar asistencia</a></td>
                                    </tr>
                                </tbody>                                         
                                <%
                                                }
