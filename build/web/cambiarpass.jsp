...
<html>
    ...
    <body>
        ...
        <section class="login-content">
            ...
            <div class="login-box">
                <form name="f1" class="login-form" action="/administradocs/loginControlador" method="POST">
                    <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Cambiar contraseña</h3>
                    <div class="form-group">
                        <label class="control-label">Token</label>
                        <input name="token" class="form-control" type="text" placeholder="token" autofocus>
                    </div>
                                        <div class="form-group">
                    ...
                    <div class="form-group btn-container">
                        <button name="btn-cambiar" class="btn btn-primary btn-block"><i class="fa fa-sign-in fa-lg fa-fw"></i>Cambiar</button>
                    </div>
                </form>
            </div>
        </section>
