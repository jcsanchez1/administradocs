...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="#">nuevos</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tile-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <%
                                try {
                                    sql = "SELECT tbl_bitacora.idbitacora, tbl_bitacora.tabla, tbl_bitacora.fechacreacion, tbl_bitacora.executedSQL, tbl_bitacora.reverseSQL FROM tbl_bitacora WHERE tbl_bitacora.accion = 'insert' ORDER BY tbl_bitacora.tabla";
