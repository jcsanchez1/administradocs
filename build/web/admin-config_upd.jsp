                    ...
                    <div class="container">
                        <form name="configuracion" action="/administradocs/configuracionControlador" method="POST" enctype="MULTIPART/FORM-DATA">
                            <div class="form-group row">
                                <label for="logogrande" class="col-4 col-form-label">Logo Grande</label> 
                                <div class="col-8 file-upload-wrapper">
                                    <input id="logogrande" name="logogrande" type="file" class="form-control file-upload" required="required">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="offset-4 col-8">
                                    <button name="btn-config" type="btn-config" class="btn btn-primary">Guardar</button>
                                </div>
                            </div>
                        </form>
                    </div>
