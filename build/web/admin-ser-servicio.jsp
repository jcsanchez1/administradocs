...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-th-list"></i> COOPERTATIVA</h1>
                        ...
                        <div class="tile-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <%
                                        try {
                                            sql = "SELECT tbl_servicios.idservicios, tbl_servicios.servicio, tbl_servicios.estado FROM tbl_servicios";
                                            rs = cn.ejecutarConsultaprograma(sql);
...
;
                                    ...
                                    <td><% if (a3.equals("1")) {%>
                                        ...
                                        <%}%></td> 
                                    <td>
                                        <a href="sac-afi-mod.jsp?id=<%=a1%>" class="btn btn-info">modificar</a>
                                        <a href="sac-afi-cam.jsp?id=<%=a1%>"class="btn btn-secondary">Cambiar estado</a>
                                    </td>
                                        </tr>
                                        <% } %>
                                    </tbody>
