                ...
                try {
                    ...
                    if (respuesta != 0) {
                        ...
                        if (tp.getIdrol().getIdrol() == 1) {
                            ...
                            response.sendRedirect("/administradocs/afiliado-index.jsp");
                        } else if (tp.getIdrol().getIdrol() == 3) {
                            response.sendRedirect("/administradocs/sac-index.jsp");
                        } else if (tp.getIdrol().getIdrol() == 4) {
                            response.sendRedirect("/administradocs/caja-index.jsp");
                        } else if (tp.getIdrol().getIdrol() == 5) {
                            response.sendRedirect("/administradocs/pantalla-index.jsp");

                        } else if (tp.getIdrol().getIdrol() == 6) {
                            response.sendRedirect("/administradocs/educacion-index.jsp");
