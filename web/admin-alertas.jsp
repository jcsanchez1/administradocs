...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="admin-alertas.jsp?idper=<%=b%>"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label"> Alertas</span></a></li>
    ...
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="#">Inserts</a></li>
                            ...
                            <a href="admin-ale-new.jsp" class="btn btn-primary btn-lg">Nueva Alerta</a>
                            <br>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody class="text-center">
                                ...
                                %><tr>
                                    ...
                                    <td><a class="btn btn-primary" href="admin-mod-ale.jsp?id=<%=a1%>"> Modificar Estado</a></td> 
                                </tr>
                                <% } %>
                            </tbody>
                            <%
