            ...
            <ul class="app-menu">
                ...
                <li class="treeview is-expanded"><a class="app-menu__item is-expanded" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Usuarios</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
                        ...
                        <li><a class="treeview-item active" href="admin-user-edu-index.jsp"><i class="icon fa fa-circle-o"></i> Educacion</a></li>                        
                    </ul>
                </li>
                        ...
                        <div class="tile-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <%                                        try {
                                            sql = "SELECT tbl_personas.id, tbl_personas.idafiliacion, tbl_personas.nombre, tbl_personas.apellido, tbl_personas.telefono, tbl_personas.email, tbl_personas.`password`, tbl_personas.idrol, tbl_roles.nombrerol, tbl_personas.estado, tbl_personas.fechanacimiento, tbl_personas.id_filial, tbl_personas.genero, tbl_personas.foto FROM tbl_personas INNER JOIN tbl_roles ON tbl_personas.idrol = tbl_roles.idrol WHERE tbl_personas.idrol = 6";
