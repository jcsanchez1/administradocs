...
<html lang="en">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Cursos</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item active" href="afiliado-cur-dis.jsp"><i class="icon fa fa-circle-o"></i> Disponibles</a></li>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <%                                    try {
                                    ...
                                    sql = "SELECT tbl_cursos.curid, tbl_cursos.nombrecurso, tbl_cursos.fechainicio, tbl_cursos.fechafinal, CONCAT(tbl_instructores.nombre, ' ', tbl_instructores.apellido) as instructor, tbl_categoriacursos.nombrecategoria FROM tbl_cursos INNER JOIN tbl_instructores ON tbl_cursos.instid = tbl_instructores.instid INNER JOIN tbl_categoriacursos ON tbl_cursos.categoriaid = tbl_categoriacursos.catid WHERE tbl_cursos.fechainicio >= CURRENT_DATE();";
                                ...
                                <tr>
                                    ...
                                    <td><%=a6%></td><%
                                        ...
                                        while (rs2.next()) {
                                            ...
                                            if (a7.equals("1")) {
                                    %>
                                    <td><a href="afiliado-cur-ins-new.jsp?dni=<%=a1%>" class="btn btn-primary">Inscribirse</a></td> <%
                                        } else {%>
                                    <td><button disabled="disabled" class="btn btn-secondary" value="Inscrito"/></td><%
                                            }%>
                                </tr>                                            
                                <%  }  %>
                            </tbody>                                         
