                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody class="text-center">
                                ...
                                %><tr>
                                    ...
                                    <td>       
                                        <a href="sac-afi-cam.jsp?id=<%=a1%>"class="btn btn-primary">servicios</a><br>
                                                                                <a href="sac-afi-cam.jsp?id=<%=a1%>"class="btn btn-secondary"> puestos</a><br>
                                                                                <a href="sac-afi-cam.jsp?id=<%=a1%>"class="btn btn-success">empleados</a>
                                    </td>
                                </tr>
                                <% } %>
                            </tbody>
