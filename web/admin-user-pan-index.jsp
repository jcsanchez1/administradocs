...
<main class="app-content">
    <div class="app-title">
        <div>
            ...
            <p>Sistema de gestion de afiliado</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Usuarios</li>
            <li class="breadcrumb-item active"><a href="#">Pantalla</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <a href="sac-afi-new.jsp" class="btn btn-primary">Nuevo usuario Pantalla</a><br><br>
        </div>
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
