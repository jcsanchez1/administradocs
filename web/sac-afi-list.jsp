...
<%
    ...
    TblPersonas tmpp = new TblPersonas();
    int respuesta = 0;
    String sql = "";
    ResultSet rs = null;
    Dba cn = new Dba();
...
<html lang="en">
    ...
    <body class="app sidebar-mini">
            ...
            <ul class="app-menu">
                ...
                <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Afiliados</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a class="treeview-item active" href="sac-afi-list.jsp"><i class="icon fa fa-circle-o"></i> Listar Afilidos Filia</a></li>
                        <li><a class="treeview-item" href="sac-afi-new.jsp"><i class="icon fa fa-circle-o"></i> Nuevo Afiliado</a></li>
        ...
        <main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="sac-afi-new.jsp" class="btn btn-primary">Nuevo Afiliado</a>
                </div>
                <div class="col-md-12">
                    <div class="tile">
                        <div class="tile-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <%                                        try {
                                            sql = "SELECT tbl_personas.id, tbl_personas.idafiliacion, tbl_personas.nombre, tbl_personas.apellido, tbl_personas.telefono, tbl_personas.email, tbl_personas.`password`, tbl_personas.idrol, tbl_roles.nombrerol, tbl_personas.estado, tbl_personas.fechanacimiento, tbl_personas.id_filial, tbl_personas.genero, tbl_personas.foto FROM tbl_personas INNER JOIN tbl_roles ON tbl_personas.idrol = tbl_roles.idrol WHERE tbl_personas.idrol = 2 AND tbl_personas.id_filial = 2";
